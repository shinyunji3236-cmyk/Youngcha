      ...
      <main className="py-12 sm:py-16">
        <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 space-y-10 sm:space-y-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
            {/* 지도 컨테이너 및 스피너 레이어 */}
            <div className="lg:col-span-2 rounded-3xl min-h-[460px] overflow-hidden relative shadow-lg shadow-slate-200/60 border border-slate-200 bg-white flex flex-col">
              {!mapLoaded && (
              ...
              {/* 지도 하단 주소 바 */}
              <div className="p-4 bg-white border-t border-slate-100 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 text-xs text-slate-600">
                <div className="flex items-center gap-2">
                ...
                <span className="text-slate-400 font-medium">영등포역 3번·5번 출구 도보 5분 거리</span>
              </div>
            </div>

            {/* 추천 코스 카드 영역 */}
            <div className="flex flex-col justify-between space-y-4">
              <div className="rounded-3xl bg-white p-6 border border-slate-200 shadow-md shadow-slate-200/50 hover:shadow-xl hover:border-blue-300 transition-all duration-300 flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="font-black text-lg text-slate-900 mt-3">
                    입이 즐거운 먹거리 탐방 코스
                  </h3>
                  <div className="mt-3 rounded-2xl bg-blue-50/50 p-3 border border-blue-100/80">
                    <p className="text-xs text-slate-700 font-medium leading-relaxed">
                      영등포 명물 순대골목 <span className="text-blue-600 font-bold">➔</span> 수제 만두 <span className="text-blue-600 font-bold">➔</span> 전통 꽈배기 <span className="text-blue-600 font-bold">➔</span> 시장 핫바
                    </p>
                  </div>
                ...
                <div className="mt-4 pt-3 border-t border-slate-100 flex items-center gap-1.5 text-xs font-bold text-blue-600">
                  <span>추천 대상: 먹거리 여행객 & 커플</span>
                </div>
              </div>

              <div className="rounded-3xl bg-white p-6 border border-slate-200 shadow-md shadow-slate-200/50 hover:shadow-xl hover:border-amber-300 transition-all duration-300 flex flex-col justify-between">
                <div>
                  <div className="flex items-center justify-between">
                  ...
                  <div className="mt-3 rounded-2xl bg-amber-50/50 p-3 border border-amber-100/80">
                    <p className="text-xs text-slate-700 font-medium leading-relaxed">
                      신선 청과 코너 <span className="text-amber-600 font-bold">➔</span> 건어물 상가 <span className="text-amber-600 font-bold">➔</span> 전통 의류 도소매 거리
                    </p>
                  </div>
                  <p className="text-xs text-slate-500 mt-3 leading-relaxed">
          ...
          <div className="rounded-3xl bg-white p-6 sm:p-8 border border-slate-200 shadow-sm">
            <h3 className="text-lg font-black text-slate-900 flex items-center gap-2 mb-6">
              <span>🚗</span> 대중교통 및 주차 이용 안내
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
              <div className="rounded-2xl bg-slate-50 p-4 border border-slate-100">
                <span className="inline-block rounded-md bg-blue-600 text-white text-[11px] font-bold px-2 py-0.5 mb-2">지하철</span>
                <h4 className="font-bold text-slate-900">1호선 영등포역</h4>
                <p className="text-xs text-slate-500 mt-1">3번 또는 5번 출구로 나와 도보 약 300m (5분 소요)</p>
              </div>
              <div className="rounded-2xl bg-slate-50 p-4 border border-slate-100">
                <span className="inline-block rounded-md bg-emerald-600 text-white text-[11px] font-bold px-2 py-0.5 mb-2">시내버스</span>
                <h4 className="font-bold text-slate-900">영등포시장 정류장</h4>
                <p className="text-xs text-slate-500 mt-1">간선 605, 661, 760 / 지선 5714, 6512 등 하차 후 바로 앞</p>
              </div>
              <div className="rounded-2xl bg-slate-50 p-4 border border-slate-100">
                <span className="inline-block rounded-md bg-amber-600 text-white text-[11px] font-bold px-2 py-0.5 mb-2">공영주차장</span>
                <h4 className="font-bold text-slate-900">영등포 전통시장 공영주차장</h4>
                <p className="text-xs text-slate-500 mt-1">시장 구매 영수증 제시 시 주차 할인 혜택 제공</p>
              </div>
            </div>
          </div>
        </div>
